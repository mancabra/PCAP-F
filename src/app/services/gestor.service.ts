...
export class GestorService {
  ...
  getPrestador(id: number) {
    return this._http.get<Gestor>(this.urlEndPoint + '/gestores/' + id)
      .pipe(catchError(this.handleError));
  }

  guardar(gestor: GestorDto) {
    return this._http.post<GestorDto>(this.urlEndPoint + '/gestores', gestor)
      .pipe(catchError(this.handleError));
  }

  actualizar(id: number, gestor: GestorDto) {
    return this._http.put<GestorDto>(this.urlEndPoint + '/gestores/' + id, gestor)
      .pipe(catchError(this.handleError));
  }

  eliminar(id: number) {
    return this._http.delete(this.urlEndPoint + '/gestores/' + id)
      .pipe(catchError(this.handleError));
  }
